 ...
 * @LastEditTime: 2020-09-10 11:18:04
...
const InflowUnMatch = props => {
  ...
  useEffect(() => {
    ...
    getTableList({
      dispatch,
      type: 'storage/getUnMatchedVendibility',
      payload: { pagination, filters, with: 'warehouse' },
    });
  ...
  return (
    <>
      <CommonUnMatch
        witchComponent="singleItem_inflow"
...
export default connect(({ loading, storage: { unMatchedList: list } }) => ({
  loading: loading.effects['storage/getUnMatchedVendibility'],
  list,
}))(InflowUnMatch);
