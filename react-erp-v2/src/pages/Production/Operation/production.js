...
import { Form, Tag, Card, Button, Popover, Col, Row, Input, Select, DatePicker, List, Progress, Drawer } from 'antd';
      ...
      <Form>
        <Item style={{ marginBottom: 0 }}>
          {getFieldDecorator('keywords')(
            <Input size='small' placeholder="生产单号搜索" />
          )}
        </Item>
        <Item style={{ marginBottom: 0 }}>
